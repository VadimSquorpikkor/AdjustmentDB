...
* <b>1.23 - 30/03/21</b>
1. Глобально переделана БД. Вместо вложенных в каждый unit список статусов теперь для ВСЕХ статусов используется ОДНА коллекция, выбор статусов для каждого юнита происходит по полю "unit_id", в которое при создании статуса заносится id текущего устройства
