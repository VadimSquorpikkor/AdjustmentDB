...
public class SingleScanFragmentOld extends Fragment {
    ...
    private ScannerOld2 scannerSingle;
    private String location;//todo надо как observe Mutable, иначе может значение не успеть подгрузиться

    public static final String EMPTY_VALUE = "- - -";

    public static SingleScanFragmentOld newInstance() {
        return new SingleScanFragmentOld();
    }
...
//            else Log.e(TAG, "* Можно Отправить данные в БД");
        ...
        scannerSingle = new ScannerOld2(getActivity(), view, mViewModel, false);
