...
public class ScannerOld {
    ...
    public ScannerOld(FragmentActivity activity, View view, MainViewModel mViewModel) {
    ...
    public void initialiseDetectorsAndSources() {
        ...
        Log.e(TAG, "♦ cameraSource = "+cameraSource);
...
//        cameraSource.stop();
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(Objects.requireNonNull(activity), Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        Log.e(TAG, "surfaceCreated: PERMISSION OK");
                    } else {
                        ActivityCompat.requestPermissions(activity, new
                                String[]{Manifest.permission.CAMERA}, REQUEST_CAMERA_PERMISSION);
                    }

                    Log.e(TAG, "surfaceCreated: OK");
                } catch (IOException e) {
                    e.printStackTrace();
                    Log.e(TAG, "surfaceCreatedException: "+e);
                }
            }
            ...
            public void surfaceDestroyed(SurfaceHolder holder) {
                Log.e(TAG, "surfaceCreated: DESTROYED");
                cameraSource.stop();
            }
        });
