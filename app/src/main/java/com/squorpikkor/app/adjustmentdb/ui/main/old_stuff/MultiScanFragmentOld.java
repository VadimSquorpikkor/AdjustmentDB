...
public class MultiScanFragmentOld extends Fragment {

    private Button nextButton;
    private MainViewModel mViewModel;
    private RecyclerView recyclerFoundUnits;
    private ArrayList<DUnit> foundUnitsList;
    private ScannerOld2 scannerMulti;
    private View view;
    private SurfaceView surfaceView;

    public static MultiScanFragmentOld newInstance() {
        return new MultiScanFragmentOld();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        scannerMulti = new ScannerOld2(getActivity(), view, mViewModel, true);
//        scannerMulti = new ScannerNew(getActivity(), true, mViewModel, true);
